<%-- 
    ...
    Created on : Mar 7, 2020, 10:31:10 AM
            ...
            <div class="row container-fluid">
                ...
                <div class="col-lg-12 text-white">
                    <div id="mySidebar" class="sidebar">
                        ...
                        <a class="nav-link text-white" href="StudentDetails.jsp">Student Master</a>
                        ...
                        <a class="nav-link text-white" href="#v-pills-settings">Section</a>
                        <a class="nav-link text-white" href="#v-pills-settings" role="tab">Attendance Master</a>
                        <!--a href="#">About</a>
                        <a href="#">Services</a>
                        <a href="#">Clients</a>
                        <a href="#">Contact</a-->
                    ...
                    <div class="col-lg-5 mt-4 ml-auto text-right pr-5">
                        ...
                        Upload Class Student Detail file
                        </button>
                    </div>
                    </div>
                    <!--div class="container mt-2">
                        <table class="table border table-hover table-responsive-sm text-center">
                            ...
                            <tbody class="font-weight-bold bg-primary">
                                ...
                                %>
                              <tr>
                                  <td><input class="font-weight-bold text-center w-50" value="<1%=rs.getString("id")%>" style="border: hidden;" readonly></td>
                                <!--td><input class="font-weight-bold text-center" value="<1%=rs.getString("t_id")%>" style="border: hidden;" readonly></td-->
                                <!--td><input class="font-weight-bold text-center" value="<1%=rs.getString("t_name")%>" style="border: hidden;" readonly></td>
                                <td><input class="font-weight-bold text-center" value="<1%=rs.getString("dept_name")%>" style="border: hidden;" readonly></td>
                                <td><input class="font-weight-bold text-center" value="<1%=rs.getString("t_username")%>" style="border: hidden;" readonly></td>
                                <td><button type="button" class="btn btn-light getid" data-toggle="modal" data-id="<1%=rs.getString("id")%>" data-pass="<1%=rs.getString("t_password")%>" data-dept="<1%=rs.getString("t_dept")%>" data-usr="<1%=rs.getString("t_username")%>" data-tdesig="<1%=rs.getString("t_design")%>" data-tname="<1%=rs.getString("t_name")%>" data-tid="<1%=rs.getString("t_id")%>" data-target="#exampleModalView">
                        <i class="fa fa-eye"></i></button></td>
                                <td><button type="button" class="btn btn-success getid" data-toggle="modal" data-id="<1%=rs.getString("id")%>" data-pass="<1%=rs.getString("t_password")%>" data-dept="<1%=rs.getString("t_dept")%>" data-usr="<1%=rs.getString("t_username")%>" data-tdesig="<1%=rs.getString("t_design")%>" data-tname="<1%=rs.getString("t_name")%>" data-tid="<1%=rs.getString("t_id")%>" data-target="#exampleModalEdit">
                    ...
                    <div class="modal-body">
                        <form action="Admin/InsertTeacher.jsp">
                            ...
                            <select class="form-control" id="section" name="section">
                                ...
                                {   Class.forName("com.mysql.jdbc.Driver"); 
                                    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/attendence?zeroDateTimeBehavior=convertToNull", "root", "");
                                    PreparedStatement ps = con.prepareStatement("select * from at_section");
                                    ResultSet rs = ps.executeQuery();
