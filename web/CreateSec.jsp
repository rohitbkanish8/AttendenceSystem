<%-- 
    Document   : CreateSec
    Created on : Mar 7, 2020, 10:48:35 AM
...
<html>
    ...
    <body>
                ...
                <div class="col-lg-12 text-white">
                    ...
                    <div class="container mt-2">
                        <table class="table border table-hover table-responsive text-center">
                            ...
                            <tbody class="font-weight-bold bg-primary">
                                ...
                                {   Class.forName("com.mysql.jdbc.Driver"); 
                                    ...
                                    PreparedStatement ps = con.prepareStatement("SELECT sec.*, s.semester_name, d.dept_name, c.course_name FROM at_section sec JOIN at_department d ON sec.dept_id = d.dept_id JOIN at_course c ON sec.course_id = c.course_id JOIN at_semester s ON sec.sem_id = s.sem_id");
                                ...
                                %>
                              <tr>
                                <td><input class="font-weight-bold text-center w-25" value="<%=rs.getString("sec_id")%>" style="border: hidden;" readonly></td>
                                <td><input class="font-weight-bold text-center w-25" value="<%=rs.getString("course_name")%>" style="border: hidden;" readonly></td>
                                <td><input class="font-weight-bold text-center w-25" value="<%=rs.getString("semester_name")%>" style="border: hidden;" readonly></td>
                                <td><input class="font-weight-bold text-center w-50" value="<%=rs.getString("section_name")%>" style="border: hidden;" readonly></td>
                        ...
                        <i class="fa fa-eye"></i> View </button></td-->
                                <td><button type="button" class="btn btn-success getid" data-toggle="modal" data-course="<%=rs.getString("course_id")%>" data-sem="<%=rs.getString("sem_id")%>" data-dept="<%=rs.getString("dept_id")%>" data-name="<%=rs.getString("section_name")%>" data-id="<%=rs.getString("sec_id")%>" data-target="#exampleModalEdit">
                        <i class="fa fa-edit"></i> Edit </button></td>
                                <td><button type="button" class="btn btn-danger delid" data-toggle="modal" data-id="<%=rs.getString("sec_id")%>" data-target="#exampleModalDelete">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="Admin/InsertSection.jsp">
                            ...
                            <div class="row ml-auto text-center mt-2">
                            <div class="col-lg-6">
                            <label class="font-weight-bold">Enter Section: </label>
                            </div>
                            <div class="col-lg-6">
                                <input class="form-control float-left" name="newsec" type="text" placeholder="Semester"/>
                            </div>
                            </div>
              ...
              <div class="modal fade" id="exampleModalEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalEditTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="Admin/Updatesection.jsp">
                            ...
                            <div class="col-lg-6">
                            <select class="form-control" id="editsem" name="editsem">
                                    <option>Select Semester...</option>
                                    <%
                                    try {
                                    Class.forName("com.mysql.jdbc.Driver"); 
                                    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/attendence?zeroDateTimeBehavior=convertToNull", "root", "");
                                    PreparedStatement ps = con.prepareStatement("select * from at_semester");
                                    ResultSet rs = ps.executeQuery();
                            ...
                            <div class="col-lg-6">
                                <input class="form-control float-left" id="editsec" name="editsec" type="text" placeholder="Section"/>
                            </div>
                            </div>
            ...
            <div class="modal fade" id="exampleModalDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalDeleteTitle" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="Admin/Deletesec.jsp">
                            <div class="row mi-auto text-center d-none">
                            <div class="col-lg-6">
                            <label class="text-dark font-weight-bold">ID: </label>
                            </div>
        ...
        <!--script>
            $(document).ready(function(){
                                        $('#editdept').change(function(){  //alert($("#dept").val());                           
					...
					$('#editcourse').change(function(){  //alert($("#course").val());                           
					...
					$('#editsem').change(function(){  //alert($("#sem").val());                           
                                           var sem=$("#editsem").val();
                                           $.post("Section.jsp",{sem:sem},function(data,status){
                                             $("#editsec").html(data);
